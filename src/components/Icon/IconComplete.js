...
const IconComplete = ({
    ...
    const gradientId = `icon-complete-gradient-${lastInstanceId}`;
    ...
    return (
        ...
        >
            <defs>
                {
                    gradient &&
                    <linearGradient id={gradientId} x1="-50%" x2="100%" gradientTransform="rotate(-40)">
                        <stop offset="0%" stopColor={gradient.from} />
                        <stop offset="60%" stopColor={gradient.to} />
                    </linearGradient>
                }
            </defs>
